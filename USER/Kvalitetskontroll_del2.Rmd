...
```{r echo = F}
## Load data
dfnew <- ReadFile(file = "HKR_2022-12-14", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH", # KH or NH
                  folder = "DATERT") # "DATERT" or 4-digit year if file in NESSTAR-folder

dfold <- ReadFile(file = "HKR_2022-11-30", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH",# KH or NH
                  folder = "DATERT") # DATERT" or 4-digit year if file in NESSTAR-folder
```
...
- For different columns, calculate
