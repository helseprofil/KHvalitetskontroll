...
```{r echo = F}
## Load data
dfnew <- ReadFile(file = "KUHR_2022-09-02-15-31", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH", # KH or NH
...
```
# 1. Initial comparison of new and old cube

- List up the structural differences between the two files
    - Number of cols 
    - Number of rows
    - Name of new cols
    - Name of new levels in different dimensions (year, INNVKAT, UTDANN, LANDBAK, etc)
    - Name of expired levels in different dimensions
```{r}
