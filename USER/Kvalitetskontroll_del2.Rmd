...
ReadFiles(dfnew = "BARNEVERN_TILTAK_2023-11-02-13-02", # FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
          foldernew = 2024, # QC, DATERT, 4-digit referring to NESSTAR-folder, or foldername (e.g. "KH2024NESSTAR_pre2024_omkod2024GEO")
          modusnew = "KH", # KH or NH
          dfold = NULL, # NULL, or FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
          folderold = NULL, # NULL, or QC, DATERT, 4-digit referring to NESSTAR-folder, or foldername (e.g. "KH2024NESSTAR_pre2024_omkod2024GEO")
