...
ReadFiles(dfnew = "e0_KH_2023-01-12-16-39", # FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
          foldernew = "2023", # QC, DATERT or 4-digit referring to NESSTAR-folder
          modusnew = "KH", # KH or NH
          dfold = "e0_KH_2022-01-24-17-25", # NULL, or FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
...
# New file
RenameColumns(dfnew, 
              old = NULL, # NULL, "old name" OR c("old name 1", "old name 2", etc)
