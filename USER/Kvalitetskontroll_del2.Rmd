...
```{r echo = F}
## Load data
dfnew <- ReadFile(file = "TRANGBODDHET_2022-10-28-11", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH", # KH or NH
...
DIMENSIONS <- c("GEO", "AAR", "ALDER", "UTDANN", "INNVKAT", "BODD")

# Define all value columns to be compared between the two KUBEs
VALUES <- c("TELLER", "RATE", "SMR", "sumTELLER", "sumNEVNER", "SPVFLAGG")
...
PLOTTDIMS <- c("UTDANN")
PLOTTVALS <- c("sumTELLER", "sumNEVNER")
```
...
# Time-series across selected dimensions
```{r message = F}
PlotTimeseries(dims = "BODD",
               vals = PLOTTVALS)
```
...
# Production year is defined in input
