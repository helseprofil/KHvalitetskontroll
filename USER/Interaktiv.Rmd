...
- Prints a table with one row per bydel, one column per year
- By default show SPVFLAGG, to identify if numbers are censored (3) or actually missing (1)
    - To show data, change the value of "maltall"
- If a dimension is present but not specified, all levels will be shown in the table, making it harder to read
...
ShowBydel(data = data, 
          ...
          landbak = NULL,
          extradim = "KODEGRUPPE",
          extraval = "Dod_med_hjerte_og_karsykdom")
```
