...
ReadFiles(dfnew = "QC_ENEFHIB_2023-04-21-12-47", # FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
          foldernew = "QC", # QC, DATERT or 4-digit referring to NESSTAR-folder
          modusnew = "KH", # KH or NH
          dfold = "ENEFHIB_2021-10-06-10-18", # NULL, or FILENAME with full date tag e.g. KUBENAVN_YYYY-MM-DD-hh-dd
...
CompareFylkeLand(groupdim = GROUPdims, compare = "sumTELLER_uprikk")
```
