...
- Ny fil, de ulike sjekkene er tilpasset.
...
# Load old data file
dfold <<- ReadFile(file = "MOBBING_UNGDATA", # Matching, if >1 file found in folder, specify file name further. Example "KUHR_2022-11-23-15-11""
                  modus = "KH",# KH or NH
