...
```{r echo = F}
## Load data
dfnew <- ReadFile(file = "DAAR", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH", # KH or NH
                  folder = 2023) # "DATERT" or 4-digit year if file in NESSTAR-folder

dfold <- ReadFile(file = "DAAR", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH",# KH or NH
