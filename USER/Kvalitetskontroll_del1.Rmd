...
```{r echo = F}
## Load new data file
dfnew <- ReadFile(file = "ENEFHIB_NH_2023-03-13-19-27", # Matching, if >1 file found in folder, specify file name further. Example: "KUHR_2022-11-23-15-11"
                  modus = "NH", # KH or NH
...
```{r echo = F}
# If no old file exists (new indicator), uncomment the next line and delete the rest of this code chunk.
# dfold <<- NULL

# Load old data file
dfold <<- ReadFile(file = "ENEFHIB", # Matching, if >1 file found in folder, specify file name further. Example: "KUHR_2022-11-23-15-11"
                  modus = "NH",# KH or NH
