...
```{r echo = F}
## Load data
dfnew <- ReadFile(file = "KUHR", # Matching, if >1 file found in folder, specify file name further
                  modus = "KH", # KH or NH
...
```{r}
CompareBydelKommune() %>% filter(KOMMUNE == "Oslo", KODEGRUPPE == "HjerteKarTotalt")
```
