...
```{r}
# If any dimensions is not present in both files, this function will crash
# If any dimensions are identified as new or expired columns (i.e. not present in both files), the dims-argument can be specified manually
# dims = c("GEO", "AAR", "KJONN", "ALDER", etc)

CompareDims(dims = c(STANDARDdims, EXTRAdims))
```
